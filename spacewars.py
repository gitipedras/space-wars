...
print("--------------------- Space Wars 1.1 Console ------------------")
print("Welcome to Space Wars 1.1")

print("You can also play from the inicial screen spacewars.py")

print("Go RED! Go Yello!")


WIN = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("Space Wars 1.2")
...
HEALTH_FONT = pygame.font.SysFont('Comic Neue', 40)
WINNER_FONT = pygame.font.SysFont('Comic Neue', 100)
